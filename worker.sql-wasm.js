...
g=f("sqlite3_open","number",["string","number"]),m=f("sqlite3_close_v2","number",["number"]),p=f("sqlite3_exec","number",["number","string","number","number","number"]),w=f("sqlite3_changes","number",["number"]),u=f("sqlite3_prepare_v2","number",["number","string","number","number","number"]),C=f("sqlite3_sql","string",["number"]),I=f("sqlite3_normalized_sql","string",["number"]),aa=f("sqlite3_prepare_v2","number",["number","number","number","number","number"]),lc=f("sqlite3_bind_text","number",["number",
...
1)q[t]=x[h+t];return q};a.prototype.get=function(h,l){l=l||{};null!=h&&this.bind(h)&&this.step();h=[];for(var q=sc(this.Ta),t=0;t<q;t+=1)switch(wc(this.Ta,t)){case 1:var z=l.useBigInt?this.Jb(t):this.Bb(t);h.push(z);break;case 2:h.push(this.Bb(t));break;case 3:h.push(this.Kb(t));break;case 4:h.push(this.getBlob(t));break;default:h.push(null)}return h};a.prototype.getColumnNames=function(){for(var h=[],l=rc(this.Ta),q=0;q<l;q+=1)h.push(xc(this.Ta,q));return h};a.prototype.getAsObject=function(h,l){h=
this.get(h,l);l=this.getColumnNames();for(var q={},t=0;t<l.length;t+=1)q[l[t]]=h[t];return q};a.prototype.getSQL=function(){return C(this.Ta)};a.prototype.getNormalizedSQL=function(){return I(this.Ta)};a.prototype.run=function(h){null!=h&&this.bind(h);this.step();return this.reset()};a.prototype.wb=function(h,l){null==l&&(l=this.Ra,this.Ra+=1);h=fa(h);var q=ha(h);this.nb.push(q);this.db.handleError(lc(this.Ta,l,q,h.length-1,0))};a.prototype.Eb=function(h,l){null==l&&(l=this.Ra,this.Ra+=1);var q=ha(h);
...
l+'";',0,0,d))};c.prototype.createVSVTable=function(h,l,q,t){if(!this.db)throw"Database closed";if(null==h)throw"No data for VSV file";postMessage({progress:"Loading "+l+"..."});let z="vsvfile_"+(4294967295*Math.random()>>>0);null!=h&&ea(z,h);this.handleError(p(this.db,'CREATE VIRTUAL TABLE "'+l+"\" USING vsv(filename='"+z+"', fsep='\\x"+q+"', header=true, affinity=real);",0,0,d));t?(postMessage({vsvtable:l,vsvback:z}),postMessage({progress:"File "+l+" loaded."})):(h="Table"+l.replace(/ /g,"").replace(".",
...
c.prototype.exec=function(h,l,q){if(!this.db)throw"Database closed";var t=ka(),z=null;try{var U=ca(h)+1,G=v(U);k(h,x,G,U);var ja=G;var ba=v(4);for(h=[];0!==r(ja,"i8");){la(d);la(ba);this.handleError(aa(this.db,ja,-1,d,ba));var D=r(d,"i32");ja=r(ba,"i32");if(0!==D){U=null;z=new a(D,this);for(null!=l&&z.bind(l);z.step();)null===U&&(U={columns:z.getColumnNames(),values:[]},h.push(U)),U.values.push(z.get(null,q));z.free()}}return h}catch(N){throw z&&z.free(),N;}finally{ma(t)}};c.prototype.each=function(h,
l,q,t,z){"function"===typeof l&&(t=q,q=l,l=void 0);h=this.prepare(h,l);try{for(;h.step();)q(h.getAsObject(null,z))}finally{h.free()}if("function"===typeof t)return t()};c.prototype.prepare=function(h,l){la(d);this.handleError(u(this.db,h,-1,d,0));h=r(d,"i32");if(0===h)throw"Nothing to prepare";var q=new a(h,this);null!=l&&q.bind(l);return this.hb[h]=q};c.prototype.iterateStatements=function(h){return new b(h,this)};c.prototype["export"]=function(){Object.values(this.hb).forEach(function(l){l.free()});
...
c.prototype.create_function=function(h,l){Object.prototype.hasOwnProperty.call(this.Za,h)&&(na(this.Za[h]),delete this.Za[h]);var q=qa(function(t,z,U){for(var G,ja=[],ba=0;ba<z;ba+=1){var D=r(U+4*ba,"i32"),N=Cc(D);if(1===N||2===N)D=Gc(D);else if(3===N)D=Ec(D);else if(4===N){N=D;D=Dc(N);N=Fc(N);for(var vb=new Uint8Array(D),Aa=0;Aa<D;Aa+=1)vb[Aa]=x[N+Aa];D=vb}else D=null;ja.push(D)}try{G=l.apply(null,ja)}catch(Nc){sb(t,Nc,-1);return}switch(typeof G){case "boolean":Kc(t,G?1:0);break;case "number":Hc(t,
G);break;case "string":Ic(t,G,-1,-1);break;case "object":null===G?rb(t):null!=G.length?(z=ha(G),Jc(t,z,G.length,-1),ia(z)):sb(t,"Wrong API use : tried to return a value of an unknown type ("+G+").",-1);break;default:rb(t)}});this.Za[h]=q;this.handleError(Bc(this.db,h,l.length,1,0,q,0,0,0));return this};e.Database=c};var ra={},A;for(A in e)e.hasOwnProperty(A)&&(ra[A]=e[A]);
...
xa=function(a,b,c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=function(){200==d.status||0==d.status&&d.response?b(d.response):c()};d.onerror=c;d.send(null)};var Ca=e.print||console.log.bind(console),F=e.printErr||console.warn.bind(console);for(A in ra)ra.hasOwnProperty(A)&&(e[A]=ra[A]);ra=null;e.thisProgram&&(sa=e.thisProgram);var Da=[],Ea;function na(a){Ea.delete(H.get(a));Da.push(a)}
...
function Ma(a,b,c,d){var f={string:function(u){var C=0;if(null!==u&&void 0!==u&&0!==u){var I=(u.length<<2)+1;C=v(I);k(u,n,C,I)}return C},array:function(u){var C=v(u.length);x.set(u,C);return C}};a=La(a);var g=[],m=0;if(d)for(var p=0;p<d.length;p++){var w=f[c[p]];w?(0===m&&(m=ka()),g[p]=w(d[p])):g[p]=d[p]}c=a.apply(null,g);return c=function(u){0!==m&&ma(m);return"string"===b?y(u):"boolean"===b?!!u:u}(c)}var Na=0,Oa=1;
...
function eb(a){for(;0<a.length;){var b=a.shift();if("function"==typeof b)b(e);else{var c=b.Ub;"number"===typeof c?void 0===b.ob?H.get(c)():H.get(c)(b.ob):c(void 0===b.ob?null:b.ob)}}}function fb(a){return a.replace(/\b_Z[\w\d_]+/g,function(b){return b===b?b:b+" ["+b+"]"})}
...
var yb={open:function(a){var b=ub[a.node.rdev];if(!b)throw new P(43);a.tty=b;a.seekable=!1},close:function(a){a.tty.fb.flush(a.tty)},flush:function(a){a.tty.fb.flush(a.tty)},read:function(a,b,c,d){if(!a.tty||!a.tty.fb.Cb)throw new P(60);for(var f=0,g=0;g<d;g++){try{var m=a.tty.fb.Cb(a.tty)}catch(p){throw new P(29);}if(void 0===m&&0===f)throw new P(6);if(null===m||void 0===m)break;f++;b[c+g]=m}f&&(a.node.timestamp=Date.now());return f},write:function(a,b,c,d){if(!a.tty||!a.tty.fb.sb)throw new P(60);
try{for(var f=0;f<d;f++)a.tty.fb.sb(a.tty,b[c+f])}catch(g){throw new P(29);}d&&(a.node.timestamp=Date.now());return f}},zb={Cb:function(a){if(!a.input.length){var b=null;if(va){var c=Buffer.alloc(256),d=0;try{d=za.readSync(process.stdin.fd,c,0,256,null)}catch(f){if(f.toString().includes("EOF"))d=0;else throw f;}0<d?b=c.slice(0,d).toString("utf-8"):b=null}else"undefined"!=typeof window&&"function"==typeof window.prompt?(b=window.prompt("Input: "),null!==b&&(b+="\n")):"function"==typeof readline&&(b=
...
var Q={Xa:null,Ya:function(){return Q.createNode(null,"/",16895,0)},createNode:function(a,b,c,d){if(24576===(c&61440)||4096===(c&61440))throw new P(63);Q.Xa||(Q.Xa={dir:{node:{Wa:Q.Oa.Wa,Va:Q.Oa.Va,lookup:Q.Oa.lookup,ib:Q.Oa.ib,rename:Q.Oa.rename,unlink:Q.Oa.unlink,rmdir:Q.Oa.rmdir,readdir:Q.Oa.readdir,symlink:Q.Oa.symlink},stream:{ab:Q.Pa.ab}},file:{node:{Wa:Q.Oa.Wa,Va:Q.Oa.Va},stream:{ab:Q.Pa.ab,read:Q.Pa.read,write:Q.Pa.write,ub:Q.Pa.ub,jb:Q.Pa.jb,kb:Q.Pa.kb}},link:{node:{Wa:Q.Oa.Wa,Va:Q.Oa.Va,
readlink:Q.Oa.readlink},stream:{}},yb:{node:{Wa:Q.Oa.Wa,Va:Q.Oa.Va},stream:Db}});c=Eb(a,b,c,d);R(c.mode)?(c.Oa=Q.Xa.dir.node,c.Pa=Q.Xa.dir.stream,c.Qa={}):32768===(c.mode&61440)?(c.Oa=Q.Xa.file.node,c.Pa=Q.Xa.file.stream,c.Ua=0,c.Qa=null):40960===(c.mode&61440)?(c.Oa=Q.Xa.link.node,c.Pa=Q.Xa.link.stream):8192===(c.mode&61440)&&(c.Oa=Q.Xa.yb.node,c.Pa=Q.Xa.yb.stream);c.timestamp=Date.now();a&&(a.Qa[b]=c,a.timestamp=c.timestamp);return c},Vb:function(a){return a.Qa?a.Qa.subarray?a.Qa.subarray(0,a.Ua):
...
b.size=4096:32768===(a.mode&61440)?b.size=a.Ua:40960===(a.mode&61440)?b.size=a.link.length:b.size=0;b.atime=new Date(a.timestamp);b.mtime=new Date(a.timestamp);b.ctime=new Date(a.timestamp);b.Ib=4096;b.blocks=Math.ceil(b.size/b.Ib);return b},Va:function(a,b){void 0!==b.mode&&(a.mode=b.mode);void 0!==b.timestamp&&(a.timestamp=b.timestamp);void 0!==b.size&&Q.Rb(a,b.size)},lookup:function(){throw Fb[44];},ib:function(a,b,c,d){return Q.createNode(a,b,c,d)},rename:function(a,b,c){if(R(a.mode)){try{var d=
Gb(b,c)}catch(g){}if(d)for(var f in d.Qa)throw new P(55);}delete a.parent.Qa[a.name];a.parent.timestamp=Date.now();a.name=c;b.Qa[c]=a;b.timestamp=a.parent.timestamp;a.parent=b},unlink:function(a,b){delete a.Qa[b];a.timestamp=Date.now()},rmdir:function(a,b){var c=Gb(a,b),d;for(d in c.Qa)throw new P(55);delete a.Qa[b];a.timestamp=Date.now()},readdir:function(a){var b=[".",".."],c;for(c in a.Qa)a.Qa.hasOwnProperty(c)&&b.push(c);return b},symlink:function(a,b,c){a=Q.createNode(a,b,41471,0);a.link=c;return a},
readlink:function(a){if(40960!==(a.mode&61440))throw new P(28);return a.link}},Pa:{read:function(a,b,c,d,f){var g=a.node.Qa;if(f>=a.node.Ua)return 0;a=Math.min(a.node.Ua-f,d);if(8<a&&g.subarray)b.set(g.subarray(f,f+a),c);else for(d=0;d<a;d++)b[c+d]=g[f+d];return a},write:function(a,b,c,d,f,g){b.buffer===x.buffer&&(g=!1);if(!d)return 0;a=a.node;a.timestamp=Date.now();if(b.subarray&&(!a.Qa||a.Qa.subarray)){if(g)return a.Qa=b.subarray(c,c+d),a.Ua=d;if(0===a.Ua&&0===f)return a.Qa=b.slice(c,c+d),a.Ua=
d;if(f+d<=a.Ua)return a.Qa.set(b.subarray(c,c+d),f),d}Q.zb(a,f+d);if(a.Qa.subarray&&b.subarray)a.Qa.set(b.subarray(c,c+d),f);else for(g=0;g<d;g++)a.Qa[f+g]=b[c+g];a.Ua=Math.max(a.Ua,f+d);return d},ab:function(a,b,c){1===c?b+=a.position:2===c&&32768===(a.node.mode&61440)&&(b+=a.node.Ua);if(0>b)throw new P(28);return b},ub:function(a,b,c){Q.zb(a.node,b+c);a.node.Ua=Math.max(a.node.Ua,b+c)},jb:function(a,b,c,d,f,g){if(0!==b)throw new P(28);if(32768!==(a.node.mode&61440))throw new P(43);a=a.node.Qa;if(g&
2||a.buffer!==Sa){if(0<d||d+c<a.length)a.subarray?a=a.subarray(d,d+c):a=Array.prototype.slice.call(a,d,d+c);d=!0;c=Bb(c);if(!c)throw new P(48);x.set(a,c)}else d=!1,c=a.byteOffset;return{Qb:c,mb:d}},kb:function(a,b,c,d,f){if(32768!==(a.node.mode&61440))throw new P(43);if(f&2)return 0;Q.Pa.write(a,b,0,d,c,!1);return 0}}},Hb=null,Ib={},S=[],Jb=1,T=null,Kb=!0,V={},P=null,Fb={};
function W(a,b){a=tb("/",a);b=b||{};if(!a)return{path:"",node:null};var c={Ab:!0,tb:0},d;for(d in c)void 0===b[d]&&(b[d]=c[d]);if(8<b.tb)throw new P(32);a=lb(a.split("/").filter(function(m){return!!m}),!1);var f=Hb;c="/";for(d=0;d<a.length;d++){var g=d===a.length-1;if(g&&b.parent)break;f=Gb(f,a[d]);c=O(c+"/"+a[d]);f.cb&&(!g||g&&b.Ab)&&(f=f.cb.root);if(!g||b.$a)for(g=0;40960===(f.mode&61440);)if(f=Lb(c),c=tb(mb(c),f),f=W(c,{tb:b.tb}).node,40<g++)throw new P(32);}return{path:c,node:f}}
function Mb(a){for(var b;;){if(a===a.parent)return a=a.Ya.Db,b?"/"!==a[a.length-1]?a+"/"+b:a+b:a;b=b?a.name+"/"+b:a.name;a=a.parent}}function Nb(a,b){for(var c=0,d=0;d<b.length;d++)c=(c<<5)-c+b.charCodeAt(d)|0;return(a+c>>>0)%T.length}function Ob(a){var b=Nb(a.parent.id,a.name);if(T[b]===a)T[b]=a.eb;else for(b=T[b];b;){if(b.eb===a){b.eb=a.eb;break}b=b.eb}}
function Gb(a,b){var c;if(c=(c=Pb(a,"x"))?c:a.Oa.lookup?0:2)throw new P(c,a);for(c=T[Nb(a.id,b)];c;c=c.eb){var d=c.name;if(c.parent.id===a.id&&d===b)return c}return a.Oa.lookup(a,b)}function Eb(a,b,c,d){a=new Qb(a,b,c,d);b=Nb(a.parent.id,a.name);a.eb=T[b];return T[b]=a}function R(a){return 16384===(a&61440)}var Rb={r:0,"r+":2,w:577,"w+":578,a:1089,"a+":1090};function Sb(a){var b=["r","w","rw"][a&3];a&512&&(b+="w");return b}
function Pb(a,b){if(Kb)return 0;if(!b.includes("r")||a.mode&292){if(b.includes("w")&&!(a.mode&146)||b.includes("x")&&!(a.mode&73))return 2}else return 2;return 0}function Tb(a,b){try{return Gb(a,b),20}catch(c){}return Pb(a,"wx")}function Ub(a,b,c){try{var d=Gb(a,b)}catch(f){return f.Sa}if(a=Pb(a,"wx"))return a;if(c){if(!R(d.mode))return 54;if(d===d.parent||"/"===Mb(d))return 10}else if(R(d.mode))return 31;return 0}function Vb(a){var b=4096;for(a=a||0;a<=b;a++)if(!S[a])return a;throw new P(33);}
function Wb(a,b){Xb||(Xb=function(){},Xb.prototype={});var c=new Xb,d;for(d in a)c[d]=a[d];a=c;b=Vb(b);a.fd=b;return S[b]=a}var Db={open:function(a){a.Pa=Ib[a.node.rdev].Pa;a.Pa.open&&a.Pa.open(a)},ab:function(){throw new P(70);}};function xb(a,b){Ib[a]={Pa:b}}
function Yb(a,b){var c="/"===b,d=!b;if(c&&Hb)throw new P(10);if(!c&&!d){var f=W(b,{Ab:!1});b=f.path;f=f.node;if(f.cb)throw new P(10);if(!R(f.mode))throw new P(54);}b={type:a,Wb:{},Db:b,Ob:[]};a=a.Ya(b);a.Ya=b;b.root=a;c?Hb=a:f&&(f.cb=b,f.Ya&&f.Ya.Ob.push(b))}function Zb(a,b,c){var d=W(a,{parent:!0}).node;a=nb(a);if(!a||"."===a||".."===a)throw new P(28);var f=Tb(d,a);if(f)throw new P(f);if(!d.Oa.ib)throw new P(63);return d.Oa.ib(d,a,b,c)}
function X(a,b){return Zb(a,(void 0!==b?b:511)&1023|16384,0)}function $b(a,b,c){"undefined"===typeof c&&(c=b,b=438);Zb(a,b|8192,c)}function ac(a,b){if(!tb(a))throw new P(44);var c=W(b,{parent:!0}).node;if(!c)throw new P(44);b=nb(b);var d=Tb(c,b);if(d)throw new P(d);if(!c.Oa.symlink)throw new P(63);c.Oa.symlink(c,b,a)}
function pa(a){var b=W(a,{parent:!0}).node,c=nb(a),d=Gb(b,c),f=Ub(b,c,!1);if(f)throw new P(f);if(!b.Oa.unlink)throw new P(63);if(d.cb)throw new P(10);try{V.willDeletePath&&V.willDeletePath(a)}catch(g){F("FS.trackingDelegate['willDeletePath']('"+a+"') threw an exception: "+g.message)}b.Oa.unlink(b,c);Ob(d);try{if(V.onDeletePath)V.onDeletePath(a)}catch(g){F("FS.trackingDelegate['onDeletePath']('"+a+"') threw an exception: "+g.message)}}
function Lb(a){a=W(a).node;if(!a)throw new P(44);if(!a.Oa.readlink)throw new P(28);return tb(Mb(a.parent),a.Oa.readlink(a))}function bc(a,b){a=W(a,{$a:!b}).node;if(!a)throw new P(44);if(!a.Oa.Wa)throw new P(63);return a.Oa.Wa(a)}function cc(a){return bc(a,!0)}function dc(a,b){a="string"===typeof a?W(a,{$a:!0}).node:a;if(!a.Oa.Va)throw new P(63);a.Oa.Va(a,{mode:b&4095|a.mode&-4096,timestamp:Date.now()})}
function ec(a){a="string"===typeof a?W(a,{$a:!0}).node:a;if(!a.Oa.Va)throw new P(63);a.Oa.Va(a,{timestamp:Date.now()})}function fc(a,b){if(0>b)throw new P(28);a="string"===typeof a?W(a,{$a:!0}).node:a;if(!a.Oa.Va)throw new P(63);if(R(a.mode))throw new P(31);if(32768!==(a.mode&61440))throw new P(28);var c=Pb(a,"w");if(c)throw new P(c);a.Oa.Va(a,{size:b,timestamp:Date.now()})}
function gc(a,b,c,d){if(""===a)throw new P(44);if("string"===typeof b){var f=Rb[b];if("undefined"===typeof f)throw Error("Unknown file open mode: "+b);b=f}c=b&64?("undefined"===typeof c?438:c)&4095|32768:0;if("object"===typeof a)var g=a;else{a=O(a);try{g=W(a,{$a:!(b&131072)}).node}catch(m){}}f=!1;if(b&64)if(g){if(b&128)throw new P(20);}else g=Zb(a,c,0),f=!0;if(!g)throw new P(44);8192===(g.mode&61440)&&(b&=-513);if(b&65536&&!R(g.mode))throw new P(54);if(!f&&(c=g?40960===(g.mode&61440)?32:R(g.mode)&&
("r"!==Sb(b)||b&512)?31:Pb(g,Sb(b)):44))throw new P(c);b&512&&fc(g,0);b&=-131713;d=Wb({node:g,path:Mb(g),flags:b,seekable:!0,position:0,Pa:g.Pa,Tb:[],error:!1},d);d.Pa.open&&d.Pa.open(d);!e.logReadFiles||b&1||(hc||(hc={}),a in hc||(hc[a]=1,F("FS.trackingDelegate error on read file: "+a)));try{V.onOpenFile&&(g=0,1!==(b&2097155)&&(g|=1),0!==(b&2097155)&&(g|=2),V.onOpenFile(a,g))}catch(m){F("FS.trackingDelegate['onOpenFile']('"+a+"', flags) threw an exception: "+m.message)}return d}
function Lc(a){if(null===a.fd)throw new P(8);a.qb&&(a.qb=null);try{a.Pa.close&&a.Pa.close(a)}catch(b){throw b;}finally{S[a.fd]=null}a.fd=null}function Mc(a,b,c){if(null===a.fd)throw new P(8);if(!a.seekable||!a.Pa.ab)throw new P(70);if(0!=c&&1!=c&&2!=c)throw new P(28);a.position=a.Pa.ab(a,b,c);a.Tb=[]}
function Oc(a,b,c,d,f){if(0>d||0>f)throw new P(28);if(null===a.fd)throw new P(8);if(1===(a.flags&2097155))throw new P(8);if(R(a.node.mode))throw new P(31);if(!a.Pa.read)throw new P(28);var g="undefined"!==typeof f;if(!g)f=a.position;else if(!a.seekable)throw new P(70);b=a.Pa.read(a,b,c,d,f);g||(a.position+=b);return b}
function Pc(a,b,c,d,f,g){if(0>d||0>f)throw new P(28);if(null===a.fd)throw new P(8);if(0===(a.flags&2097155))throw new P(8);if(R(a.node.mode))throw new P(31);if(!a.Pa.write)throw new P(28);a.seekable&&a.flags&1024&&Mc(a,0,2);var m="undefined"!==typeof f;if(!m)f=a.position;else if(!a.seekable)throw new P(70);b=a.Pa.write(a,b,c,d,f,g);m||(a.position+=b);try{if(a.path&&V.onWriteToFile)V.onWriteToFile(a.path)}catch(p){F("FS.trackingDelegate['onWriteToFile']('"+a.path+"') threw an exception: "+p.message)}return b}
...
function Qc(){P||(P=function(a,b){this.node=b;this.Sb=function(c){this.Sa=c};this.Sb(a);this.message="FS error"},P.prototype=Error(),P.prototype.constructor=P,[44].forEach(function(a){Fb[a]=new P(a);Fb[a].stack="<generic error, no stack>"}))}var Rc;function Sc(a,b){var c=0;a&&(c|=365);b&&(c|=146);return c}
function ea(a,b){var c=a?O("//"+a):"/";a=Sc(!0,!0);c=Zb(c,(void 0!==a?a:438)&4095|32768,0);if(b){if("string"===typeof b){for(var d=Array(b.length),f=0,g=b.length;f<g;++f)d[f]=b.charCodeAt(f);b=d}dc(c,a|146);d=gc(c,577);Pc(d,b,0,b.length,0,void 0);Lc(d);dc(c,a)}}
function Tc(a,b,c){a=O("/dev/"+a);var d=Sc(!!b,!!c);Uc||(Uc=64);var f=Uc++<<8|0;xb(f,{open:function(g){g.seekable=!1},close:function(){c&&c.buffer&&c.buffer.length&&c(10)},read:function(g,m,p,w){for(var u=0,C=0;C<w;C++){try{var I=b()}catch(aa){throw new P(29);}if(void 0===I&&0===u)throw new P(6);if(null===I||void 0===I)break;u++;m[p+C]=I}u&&(g.node.timestamp=Date.now());return u},write:function(g,m,p,w){for(var u=0;u<w;u++)try{c(m[p+u])}catch(C){throw new P(29);}w&&(g.node.timestamp=Date.now());return u}});
$b(a,d,f)}var Uc,Y={},Xb,hc,Vc={};
function Wc(a,b,c){try{var d=a(b)}catch(f){if(f&&f.node&&O(b)!==O(Mb(f.node)))return-54;throw f;}J[c>>2]=d.dev;J[c+4>>2]=0;J[c+8>>2]=d.ino;J[c+12>>2]=d.mode;J[c+16>>2]=d.nlink;J[c+20>>2]=d.uid;J[c+24>>2]=d.gid;J[c+28>>2]=d.rdev;J[c+32>>2]=0;K=[d.size>>>0,(L=d.size,1<=+Math.abs(L)?0<L?(Math.min(+Math.floor(L/4294967296),4294967295)|0)>>>0:~~+Math.ceil((L-+(~~L>>>0))/4294967296)>>>0:0)];J[c+40>>2]=K[0];J[c+44>>2]=K[1];J[c+48>>2]=4096;J[c+52>>2]=d.blocks;J[c+56>>2]=d.atime.getTime()/1E3|0;J[c+60>>2]=
0;J[c+64>>2]=d.mtime.getTime()/1E3|0;J[c+68>>2]=0;J[c+72>>2]=d.ctime.getTime()/1E3|0;J[c+76>>2]=0;K=[d.ino>>>0,(L=d.ino,1<=+Math.abs(L)?0<L?(Math.min(+Math.floor(L/4294967296),4294967295)|0)>>>0:~~+Math.ceil((L-+(~~L>>>0))/4294967296)>>>0:0)];J[c+80>>2]=K[0];J[c+84>>2]=K[1];return 0}var Xc=void 0;function Yc(){Xc+=4;return J[Xc-4>>2]}function Z(a){a=S[a];if(!a)throw new P(8);return a}var Zc;Zc=va?function(){var a=process.hrtime();return 1E3*a[0]+a[1]/1E6}:function(){return performance.now()};
...
function Qb(a,b,c,d){a||(a=this);this.parent=a;this.Ya=a.Ya;this.cb=null;this.id=Jb++;this.name=b;this.mode=c;this.Oa={};this.Pa={};this.rdev=d}Object.defineProperties(Qb.prototype,{read:{get:function(){return 365===(this.mode&365)},set:function(a){a?this.mode|=365:this.mode&=-366}},write:{get:function(){return 146===(this.mode&146)},set:function(a){a?this.mode|=146:this.mode&=-147}}});Qc();T=Array(4096);Yb(Q,"/");X("/tmp");X("/home");X("/home/web_user");
...
6,1)).getTimezoneOffset();c=c.getTimezoneOffset();a=(d!=c&&a.getTimezoneOffset()==Math.min(c,d))|0;J[b+32>>2]=a;a=J[jb()+(a?4:0)>>2];J[b+40>>2]=a;return b},w:function(a,b){try{a=y(a);if(b&-8)var c=-28;else{var d;(d=W(a,{$a:!0}).node)?(a="",b&4&&(a+="r"),b&2&&(a+="w"),b&1&&(a+="x"),c=a&&Pb(d,a)?-2:0):c=-44}return c}catch(f){return"undefined"!==typeof Y&&f instanceof P||E(f),-f.Sa}},D:function(a,b){try{return a=y(a),dc(a,b),0}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),-c.Sa}},t:function(a){try{return a=
y(a),ec(a),0}catch(b){return"undefined"!==typeof Y&&b instanceof P||E(b),-b.Sa}},E:function(a,b){try{var c=S[a];if(!c)throw new P(8);dc(c.node,b);return 0}catch(d){return"undefined"!==typeof Y&&d instanceof P||E(d),-d.Sa}},u:function(a){try{var b=S[a];if(!b)throw new P(8);ec(b.node);return 0}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),-c.Sa}},b:function(a,b,c){Xc=c;try{var d=Z(a);switch(b){case 0:var f=Yc();return 0>f?-28:gc(d.path,d.flags,0,f).fd;case 1:case 2:return 0;case 3:return d.flags;
case 4:return f=Yc(),d.flags|=f,0;case 12:return f=Yc(),Ga[f+0>>1]=2,0;case 13:case 14:return 0;case 16:case 8:return-28;case 9:return J[cd()>>2]=28,-1;default:return-28}}catch(g){return"undefined"!==typeof Y&&g instanceof P||E(g),-g.Sa}},H:function(a,b){try{var c=Z(a);return Wc(bc,c.path,b)}catch(d){return"undefined"!==typeof Y&&d instanceof P||E(d),-d.Sa}},x:function(a,b,c){try{var d=S[a];if(!d)throw new P(8);if(0===(d.flags&2097155))throw new P(28);fc(d.node,c);return 0}catch(f){return"undefined"!==
typeof Y&&f instanceof P||E(f),-f.Sa}},A:function(a,b){try{if(0===b)return-28;if(b<ca("/")+1)return-68;k("/",n,a,b);return a}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),-c.Sa}},B:function(){return 0},e:function(){return 42},k:function(a,b,c){Xc=c;try{var d=Z(a);switch(b){case 21509:case 21505:return d.tty?0:-59;case 21510:case 21511:case 21512:case 21506:case 21507:case 21508:return d.tty?0:-59;case 21519:if(!d.tty)return-59;var f=Yc();return J[f>>2]=0;case 21520:return d.tty?-28:
-59;case 21531:a=f=Yc();if(!d.Pa.Lb)throw new P(59);return d.Pa.Lb(d,b,a);case 21523:return d.tty?0:-59;case 21524:return d.tty?0:-59;default:E("bad ioctl syscall "+b)}}catch(g){return"undefined"!==typeof Y&&g instanceof P||E(g),-g.Sa}},F:function(a,b){try{return a=y(a),Wc(cc,a,b)}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),-c.Sa}},G:function(a,b){try{return a=y(a),a=O(a),"/"===a[a.length-1]&&(a=a.substr(0,a.length-1)),X(a,b),0}catch(c){return"undefined"!==typeof Y&&c instanceof P||
E(c),-c.Sa}},K:function(a,b,c,d,f,g){try{a:{g<<=12;var m=!1;if(0!==(d&16)&&0!==a%65536)var p=-28;else{if(0!==(d&32)){var w=Bb(b);if(!w){p=-48;break a}m=!0}else{var u=S[f];if(!u){p=-8;break a}var C=g;if(0!==(c&2)&&0===(d&2)&&2!==(u.flags&2097155))throw new P(2);if(1===(u.flags&2097155))throw new P(2);if(!u.Pa.jb)throw new P(43);var I=u.Pa.jb(u,a,b,C,c,d);w=I.Qb;m=I.mb}Vc[w]={Nb:w,Mb:b,mb:m,fd:f,Pb:c,flags:d,offset:g};p=w}}return p}catch(aa){return"undefined"!==typeof Y&&aa instanceof P||E(aa),-aa.Sa}},
J:function(a,b){try{var c=Vc[a];if(0!==b&&c){if(b===c.Mb){var d=S[c.fd];if(d&&c.Pb&2){var f=c.flags,g=c.offset,m=n.slice(a,a+b);d&&d.Pa.kb&&d.Pa.kb(d,m,g,b,f)}Vc[a]=null;c.mb&&ia(c.Nb)}var p=0}else p=-28;return p}catch(w){return"undefined"!==typeof Y&&w instanceof P||E(w),-w.Sa}},h:function(a,b,c){Xc=c;try{var d=y(a),f=c?Yc():0;return gc(d,b,f).fd}catch(g){return"undefined"!==typeof Y&&g instanceof P||E(g),-g.Sa}},z:function(a,b,c){try{a=y(a);if(0>=c)var d=-28;else{var f=Lb(a),g=Math.min(c,ca(f)),
m=x[b+g];k(f,n,b,c+1);x[b+g]=m;d=g}return d}catch(p){return"undefined"!==typeof Y&&p instanceof P||E(p),-p.Sa}},v:function(a){try{a=y(a);var b=W(a,{parent:!0}).node,c=nb(a),d=Gb(b,c),f=Ub(b,c,!0);if(f)throw new P(f);if(!b.Oa.rmdir)throw new P(63);if(d.cb)throw new P(10);try{V.willDeletePath&&V.willDeletePath(a)}catch(g){F("FS.trackingDelegate['willDeletePath']('"+a+"') threw an exception: "+g.message)}b.Oa.rmdir(b,c);Ob(d);try{if(V.onDeletePath)V.onDeletePath(a)}catch(g){F("FS.trackingDelegate['onDeletePath']('"+
a+"') threw an exception: "+g.message)}return 0}catch(g){return"undefined"!==typeof Y&&g instanceof P||E(g),-g.Sa}},i:function(a,b){try{return a=y(a),Wc(bc,a,b)}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),-c.Sa}},y:function(a){try{return a=y(a),pa(a),0}catch(b){return"undefined"!==typeof Y&&b instanceof P||E(b),-b.Sa}},I:function(){return 2147483648},m:function(a,b,c){n.copyWithin(a,b,b+c)},d:function(a){var b=n.length;a>>>=0;if(2147483648<a)return!1;for(var c=1;4>=c;c*=2){var d=b*
(1+.2/c);d=Math.min(d,a+100663296);d=Math.max(a,d);0<d%65536&&(d+=65536-d%65536);a:{try{Ja.grow(Math.min(2147483648,d)-Sa.byteLength+65535>>>16);Ta();var f=1;break a}catch(g){}f=void 0}if(f)return!0}return!1},q:function(a){for(var b=Zc();Zc()-b<a;);},o:function(a,b){var c=0;ad().forEach(function(d,f){var g=b+c;f=J[a+4*f>>2]=g;for(g=0;g<d.length;++g)x[f++>>0]=d.charCodeAt(g);x[f>>0]=0;c+=d.length+1});return 0},p:function(a,b){var c=ad();J[a>>2]=c.length;var d=0;c.forEach(function(f){d+=f.length+1});
J[b>>2]=d;return 0},c:function(a){try{var b=Z(a);Lc(b);return 0}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),c.Sa}},n:function(a,b){try{var c=Z(a);x[b>>0]=c.tty?2:R(c.mode)?3:40960===(c.mode&61440)?7:4;return 0}catch(d){return"undefined"!==typeof Y&&d instanceof P||E(d),d.Sa}},g:function(a,b,c,d){try{a:{for(var f=Z(a),g=a=0;g<c;g++){var m=J[b+(8*g+4)>>2],p=Oc(f,x,J[b+8*g>>2],m,void 0);if(0>p){var w=-1;break a}a+=p;if(p<m)break}w=a}J[d>>2]=w;return 0}catch(u){return"undefined"!==typeof Y&&
u instanceof P||E(u),u.Sa}},l:function(a,b,c,d,f){try{var g=Z(a);a=4294967296*c+(b>>>0);if(-9007199254740992>=a||9007199254740992<=a)return-61;Mc(g,a,d);K=[g.position>>>0,(L=g.position,1<=+Math.abs(L)?0<L?(Math.min(+Math.floor(L/4294967296),4294967295)|0)>>>0:~~+Math.ceil((L-+(~~L>>>0))/4294967296)>>>0:0)];J[f>>2]=K[0];J[f+4>>2]=K[1];g.qb&&0===a&&0===d&&(g.qb=null);return 0}catch(m){return"undefined"!==typeof Y&&m instanceof P||E(m),m.Sa}},s:function(a){try{var b=Z(a);return b.Pa&&b.Pa.fsync?-b.Pa.fsync(b):
0}catch(c){return"undefined"!==typeof Y&&c instanceof P||E(c),c.Sa}},f:function(a,b,c,d){try{a:{for(var f=Z(a),g=a=0;g<c;g++){var m=Pc(f,x,J[b+8*g>>2],J[b+(8*g+4)>>2],void 0);if(0>m){var p=-1;break a}a+=m}p=a}J[d>>2]=p;return 0}catch(w){return"undefined"!==typeof Y&&w instanceof P||E(w),w.Sa}},j:function(a){var b=Date.now();J[a>>2]=b/1E3|0;J[a+4>>2]=b%1E3*1E3|0;return 0},L:function(a){var b=Date.now()/1E3|0;a&&(J[a>>2]=b);return b},C:function(a,b){if(b){var c=b+8;b=1E3*J[c>>2];b+=J[c+4>>2]/1E3}else b=
Date.now();a=y(a);try{var d=W(a,{$a:!0}).node;d.Oa.Va(d,{timestamp:Math.max(b,b)});var f=0}catch(g){if(!(g instanceof P)){b:{f=Error();if(!f.stack){try{throw Error();}catch(m){f=m}if(!f.stack){f="(no stack trace available)";break b}}f=f.stack.toString()}e.extraStackTrace&&(f+="\n"+e.extraStackTrace());f=fb(f);throw g+" : "+f;}f=g.Sa;J[cd()>>2]=f;f=-1}return f}};
(function(){function a(f){e.asm=f.exports;Ja=e.asm.M;Ta();H=e.asm.Da;Va.unshift(e.asm.N);Ya--;e.monitorRunDependencies&&e.monitorRunDependencies(Ya);0==Ya&&(null!==Za&&(clearInterval(Za),Za=null),$a&&(f=$a,$a=null,f()))}function b(f){a(f.instance)}function c(f){return db().then(function(g){return WebAssembly.instantiate(g,d)}).then(function(g){return g}).then(f,function(g){F("failed to asynchronously prepare wasm: "+g);E(g)})}var d={a:dd};Ya++;e.monitorRunDependencies&&e.monitorRunDependencies(Ya);
